...
public class SccRegistrationSeller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scc_registration_seller);
...
//        final String btype = bsBType.getText().toString();
        ...
        StringRequest MyStringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(SccRegistrationSeller.this, "\"Thanks for registration, We contact shortly.", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(SccRegistrationSeller.this, SplashActivity.class);
